...
class Dataset(object):
    ...
    def __init__(self, dataset_type):
        self.annot_path = (
            cfg.TRAIN.ANNOT_PATH if dataset_type == "train" else cfg.TEST.ANNOT_PATH
        )
        self.input_sizes = (
            cfg.TRAIN.INPUT_SIZE if dataset_type == "train" else cfg.TEST.INPUT_SIZE
        )
        self.batch_size = (
            cfg.TRAIN.BATCH_SIZE if dataset_type == "train" else cfg.TEST.BATCH_SIZE
        )
        self.data_aug = (
